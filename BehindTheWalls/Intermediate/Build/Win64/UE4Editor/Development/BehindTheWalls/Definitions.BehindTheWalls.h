...
#define ORIGINAL_FILE_NAME "UE4Editor-BehindTheWalls.dll"
#define UE_IS_ENGINE_MODULE 0
#define UE_BUILD_DEVELOPMENT_WITH_DEBUGGAME 0
#define UE_PROJECT_NAME BehindTheWalls
#define DEPRECATED_FORGAME DEPRECATED
#define BEHINDTHEWALLS_API DLLEXPORT
